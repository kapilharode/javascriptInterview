...
//Explaination : If we divide "kapil"/2 then it will give NaN. 
--------------------------------
let data = 10 - -10;
console.log(data); //20
...
------------------------------------
const data = ["hatim", "kapil", "supriya"];
const [y] = data;
console.log(y); //"kapil"
...
console.log(data); // {name:"kapil", age:"ABC"}
...
let data1={city:"ABC"}
data = {data, ...data1} //merge 2 objects
console.log(data); // { "data" : {name:"kapil"}, "city": "ABC"}
...
----------------------------------------------------
const name = "kapil is a girl.";
console.log(typeof name); //string
console.log(!typeof name); //false //"kapil is a good girl" is a string means thruthy value. Nagation of thruthy is falsy value.
...
---------------------------------------------------------
let data = ["hatim", "kapil", "supriya"];
delete data[1];
console.log(data); //["hatim",,"supriya"] //["hatim",empty,"supriya"]
...
----------------------------------------------------
console.log(!"kapil"); //false
console.log(typeof ("kapil")); //string
...
person = null;
console.log(numbers, person); // [{name : "kapil"}] //null
...
----------------------------------------------------------------------------------
const person = {name: "kapil", age: 1000};
...
for(let item in user){
  console.log(user[item]) //kapil 100
}
------------------------------------------------------------------------------------------
const user ={
  name : "kapil",
...
console.log(str)//{'name':'kapil','age':100}"

//convert string onto an object
console.log(JSON.parse(str)) //{ name : "kapil, "age":100}
...
localStorage.setItem("testAsKey", JSON.stringify(user)) {"name":"kapil","age":100}
...
console.log(JSON.stringify(user,["name"])) //"{'name':'kapil'}"
...
person = null
console.log(members);// [{"name":"kapil"}]
